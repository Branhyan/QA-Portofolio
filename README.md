...
**Team Manager & QA Lead**

- Diseño completo de la estructura de casos de prueba
- Configuración de Jira con workflow personalizado
- Coordinación de equipo de 6 testers
- Ejecución de testing no funcional (performance, accesibilidad, compatibilidad)
- Revisión y validación de documentación de hallazgos
...
- **Gestión:** Jira, Trello, Planyway
- **Testing:** Chrome DevTools (performance)
- **Accesibilidad:** WAVE, WebAIM Contrast Checker
- **Navegadores:** Chrome, Edge, Opera GX
- **Documentación:** Canva, Microsoft Office
...
QA Tester Junior | Coordinador de Equipos de Testing
